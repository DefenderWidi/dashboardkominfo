...
export namespace Prisma {
  ...
  */
  ...
  export type JsonFileOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"id" | "data" | "uploadedAt", ExtArgs["result"]["jsonFile"]>
  ...
  interface JsonFileFieldRefs {
    ...
    readonly data: FieldRef<"JsonFile", 'Json'>
    readonly uploadedAt: FieldRef<"JsonFile", 'DateTime'>
  }
  ...
  export type JsonFileWhereInput = {
    ...
    data?: JsonFilter<"JsonFile">
    uploadedAt?: DateTimeFilter<"JsonFile"> | Date | string
  }
  ...
  export type JsonFileScalarWhereWithAggregatesInput = {
    ...
    data?: JsonWithAggregatesFilter<"JsonFile">
    uploadedAt?: DateTimeWithAggregatesFilter<"JsonFile"> | Date | string
  }
